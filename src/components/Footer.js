...
import { UilInstagram, UilFacebook, UilTwitterAlt, UilWhatsapp, UilPhoneAlt } from '@iconscout/react-unicons'
    ...
    return (
        <>
            ...
            <section className='bg-transparent m-auto ven-des w-[60%] p-8'>
                ...
                <img className="m-auto mb-8 h-72" src="https://grapplertodd.com/wp-content/uploads/2022/04/vendor.png" alt="logo/image" />
            ...
            <section className='w-[100%] bg-slate-600 m-auto text-white p-8 my-8'>
                ...
                <div className='social-handles flex justify-evenly items-center w-[100%] my-8 '>
                    ...
                    <p className='flex items-center'><UilInstagram className="social-icons" size="50" /><IconName text="Instagram" /></p>
                    <p className='flex items-center'><UilWhatsapp className="social-icons" size="50" /><IconName text="Whatsapp" /></p>
                    <p className='flex items-center'><UilTwitterAlt className="social-icons" size="50" /><IconName text="Twitter" /></p>
                    <p className='flex items-center'><UilFacebook className="social-icons" size="50" /><IconName text="Facebook" /></p>
            ...
            <section className='m-auto ven-des w-[100%] p-8 my-10'>
                ...
                <div className='phone-news  my-8 flex justify-between items-center'>
                    <div className='w-[50%] p-10 '>
                        <p className=' flex justify-center items-center m-auto'><UilPhoneAlt className="social-icons" size="60" /><span className='m-10'>For any queries, please call us at +91 6388835366.<br /> Our support hours are Monday to Friday, from 7 AM to 10 PM.</span></p>
                    </div>
            ...
            <footer className="w-full bg-gray-600 py-4">
                <div className="flex justify-center">
                    <div className="flex gap-4">
                        <a href="/terms" className="text-white hover:text-gray-300">Terms & Conditions</a>
                        <span className="text-white">|</span>
                        <a href="/privacy" className="text-white hover:text-gray-300">Privacy Policy</a>
                        <span className="text-white">|</span>
                        <a href="/shipping" className="text-white hover:text-gray-300">Shipping Policy</a>
                        <span className="text-white">|</span>
                        <a href="/cancellation" className="text-white hover:text-gray-300">Cancellation Policy</a>
                    </div>
                </div>
            </footer>
        </>
...
const Heading = (props) => {
    return (
        <h4 className="text-3xl text-white font-bold mb-10">{props.text}</h4>
    );
};
const Para = (props) => {
    return (
        <p className='bav-para mb-10 text-lg text-white'>{props.text}</p>
    );
};
...
function About() {
    return (
        <section className='bg-gray-600 m-auto about w-[100%] p-8'>
            ...
            <img className="bg-black rounded-xl border-2 m-auto mb-8 h-72 p-5" src="https://static.wixstatic.com/media/da6d95_322a88373265494a9a721b245371eb3f~mv2.png/v1/fill/w_1604,h_1000,al_c,q_90,usm_0.66_1.00_0.01,enc_auto/da6d95_322a88373265494a9a721b245371eb3f~mv2.png" alt="logo/image" />
